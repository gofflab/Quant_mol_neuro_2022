...
Here, we perform multidimensional scaling,
an embedding technique that takes in the distances between samples
and tries to find a low-dimensional representation of the data
that preserves the distances between samples.
