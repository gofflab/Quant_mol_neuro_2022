...
Throughout the course, we will maintain a cloud-based instance of RStudio workbench for students to use as needed. This is primarily our safeguard to streamline learning in case of troubleshooting issues on local installations (which are preferred). Prior to the first day of the course, all students will be given accounts onthe online Workbench and will have access to a working Linux/R/RStudio environment as needed. To access this server please open a web browser and go to [http://neurogenomics.gofflab.org/](http://neurogenomics.gofflab.org/).
